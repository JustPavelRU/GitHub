...
public class SnakeTheGame {
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        System.out.println("Проект старый. Переделывать надо в принципе с нуля с нормальным управлением и графикой. Не ругайте его :(");
        System.out.println("Для команды змейке напишите направление движения(WASD) и нажмите Enter.");
